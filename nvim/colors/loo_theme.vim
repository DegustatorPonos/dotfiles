hi clear
syntax reset
let g:colors_name = "loo_theme"
set background=dark
set t_Co=256
hi Normal guifg=#d8cdc7 ctermbg=NONE guibg=#27221f gui=NONE
...
hi Pmenu guifg=#d8cdc7 guibg=#454545
hi SignColumn guibg=#27221f
hi Title guifg=#d8cdc7
hi LineNr guifg=#7c6457 guibg=#27221f
hi NonText guifg=#c481ff guibg=#27221f
...
hi TabLine guifg=#7c6457 guibg=#454545 gui=NONE
hi StatusLine gui=bold guibg=#454545 guifg=#d8cdc7
hi StatusLineNC gui=NONE guibg=#27221f guifg=#d8cdc7
hi Search guibg=#c481ff guifg=#d8cdc7
